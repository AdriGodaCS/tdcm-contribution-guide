...
If you notice any errors, bugs, or parts of the package that do not work as expected, please use the Issues feature on GitHub! This will allow us to respond promptly and keep all required fixes in one place. To do so, log in to your GitHub account (or create one if you do not already have one) and follow the instructions below:
...
2. Use the search box to see if the issue you encountered has already been reported.
    ...
    * If the issue has not been reported yet, you can make your own!:
...
Git supports the creation of a pull request using the “[git-request-pull](https://git-scm.com/docs/git-request-pull)" command. (Note: This only generates a nicely formatted pull request for you to send to the owner of the original repository. It does not send the request itself. This should be done using GitHub).
